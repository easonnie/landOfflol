...
class BasicLSTM:
    def __init__(self, embedding=None, hidden_state_d=100, max_length=80, learning_rate=0.001, dropout_rate=0.5, vocab_size=400001, embedding_d=300, num_classes=2, rnn_input_dropout=0.0, rnn_output_dropout=0.0):
    ...
    def predict_fg(self, batch_data, batch_length, batch_label, name=None):
        ...
        # print('d_prediction', d_prediction[:, 0].ravel(), d_prediction[:, 0].ravel().shape)
